...
BULK INSERT dbo.children FROM 'D:\Studies\Semester 4\Data Warehouses\GeneratingData\txt_file_generator\children_insert.txt' 
WITH (FIELDTERMINATOR = ',');

BULK INSERT dbo.teachers FROM 'D:\Studies\Semester 4\Data Warehouses\GeneratingData\txt_file_generator\insert_teachers.txt' 
WITH (FIELDTERMINATOR = ',');

BULK INSERT dbo.legal_guardians FROM 'D:\Studies\Semester 4\Data Warehouses\GeneratingData\txt_file_generator\guardians_insert.txt' 
WITH (FIELDTERMINATOR = ',');

BULK INSERT dbo.parents FROM 'D:\Studies\Semester 4\Data Warehouses\GeneratingData\txt_file_generator\parents_relationship_insert.txt' 
WITH (FIELDTERMINATOR = ',');

BULK INSERT dbo.kindergartens FROM 'D:\Studies\Semester 4\Data Warehouses\GeneratingData\txt_file_generator\insert_kindergarten.txt' 
WITH (FIELDTERMINATOR = ';');

BULK INSERT dbo.enrollments FROM 'D:\Studies\Semester 4\Data Warehouses\GeneratingData\txt_file_generator\insert_enrollments.txt' 
WITH (FIELDTERMINATOR = ',');

BULK INSERT dbo.ratings FROM 'D:\Studies\Semester 4\Data Warehouses\GeneratingData\txt_file_generator\insert_ratings.txt' 
WITH (FIELDTERMINATOR = ',');
